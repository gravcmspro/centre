...
/**
 * Class CardSimpleShortcode
 *
 * @author GravCMS Pro
 */
class CardSimpleShortcode extends BaseShortcode
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'card/card_simple.html.twig';
    }
    ...
    protected function renderOutput(ShortcodeInterface $shortcode)
    {
        return $this->grav['twig']->processTemplate($this->template(), [
            'values' => array(
                ...
                'button_caption' => $shortcode->getParameter('button-caption'),
                'card_attributes' => $shortcode->getParameter('card-attributes'),
                'header_attributes' => $shortcode->getParameter('header-attributes'),
